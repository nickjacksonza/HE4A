...
const COPY = {
  en: {
    hero: {
      ...
      text: 'You already know what equity asks of your organization. We handle the governance and coaching that make it possible to deliver, without burning out the people who care most.',
    ...
    cards: {
      ...
      items: [
        ...
        { title: 'Executive Coaching', body: "Confidential monthly sessions for executive directors and senior staff, especially the ones who are first to hold their role in the organization's history." },
    ...
    approach: {
      ...
      p1: 'Governance work starts with a direct question: who is this board accountable to, and who is missing from it? We help you answer that, then build the structures that keep equity at the center of how decisions get made.',
    ...
    team: {
      subtext: 'You work directly with the person doing the work. There’s no account team.',
    ...
    faqs: [
      ...
      { q: 'Can coaching be arranged for someone other than the executive director?', a: 'Absolutely, and often it should be. We coach deputy directors, program leads and first-time managers. Every session is confidential, including from the board.' },
    ...
    cta: {
      ...
      text: 'Tell us what you’re working through and we’ll let you know how we can help.'
    },
  ...
  fr: {
    hero: {
      ...
      text: "Vous savez déjà ce que l'équité demande à votre organisation. Nous prenons en charge la gouvernance et le coaching qui rendent cela possible, sans épuiser les personnes qui s'en soucient le plus.",
    ...
    approach: {
      ...
      p1: "Le travail de gouvernance commence par une question directe : envers qui ce conseil est-il responsable, et qui manque à la table ? Nous vous aidons à y répondre, puis à construire les structures qui placent l'équité au cœur des décisions.",
    ...
    team: {
      subtext: 'Vous travaillez directement avec la personne qui fait le travail. Il n’y a pas d’équipe intermédiaire.',
    ...
    faqs: [
      { q: "Quelle est la durée typique d'une intervention en gouvernance ?", a: 'De trois à neuf mois. Une revue autonome dure généralement environ huit semaines ; ajouter un accompagnement de mise en œuvre sur deux cycles du conseil prolonge vers la durée maximale. Nous définissons le périmètre ensemble après notre premier échange.' },
        ...
        { q: "Le coaching peut-il être organisé pour quelqu'un d'autre que le directeur général ?", a: "Absolument, et c'est souvent souhaitable. Nous coachons les directeurs adjoints, responsables de programmes et gestionnaires novices. Chaque séance est confidentielle, y compris envers le conseil." },
    ...
    cta: {
      ...
      text: 'Dites-nous ce que vous traversez et nous vous dirons comment nous pouvons vous aider.'
    },
  ...
  es: {
    hero: {
      ...
      text: 'Ya sabes lo que la equidad le exige a tu organización. Nos encargamos de la gobernanza y el coaching que hacen posible cumplirlo, sin agotar a las personas que más se preocupan.',
    ...
    approach: {
      ...
      p1: 'El trabajo de gobernanza comienza con una pregunta directa: ¿ante quién responde esta junta, y quién falta en la mesa? Te ayudamos a responderla, y luego a construir las estructuras que mantienen la equidad en el centro de la toma de decisiones.',
    ...
    team: {
      subtext: 'Trabajas directamente con la persona que hace el trabajo. No hay equipo de cuentas.',
    ...
    faqs: [
      ...
      { q: '¿Se puede organizar coaching para alguien que no sea el director ejecutivo?', a: 'Por supuesto, y a menudo debería ser así. Damos coaching a subdirectores, líderes de programas y gerentes primerizos. Cada sesión es confidencial, incluso frente a la junta.' },
    ...
    cta: {
      ...
      text: 'Cuéntanos en qué estás trabajando y te diremos cómo podemos ayudar.'
    },
  ...
  pt: {
    hero: {
      ...
      text: 'Você já sabe o que a equidade exige da sua organização. Cuidamos da governança e do coaching que tornam isso possível, sem esgotar as pessoas que mais se importam.',
    ...
    approach: {
      ...
      p1: 'O trabalho de governança começa com uma pergunta direta: a quem esse conselho presta contas, e quem está faltando nele? Ajudamos você a responder, e depois a construir as estruturas que mantêm a equidade no centro das decisões.',
    ...
    team: {
      subtext: 'Você trabalha diretamente com quem faz o trabalho. Não existe equipe de contas.',
    ...
    faqs: [
      ...
      { q: 'O coaching pode ser organizado para alguém além do diretor executivo?', a: 'Sem dúvida, e muitas vezes deveria ser. Fazemos coaching com diretores adjuntos, líderes de programas e gestores de primeira vez. Cada sessão é confidencial, inclusive perante o conselho.' },
    ...
    cta: {
      ...
      text: 'Conte-nos o que você está enfrentando e diremos como podemos ajudar.'
    },
...
<section class="section band-paper-subtle">
  <div class="container">
    ...
    <div class="auto-grid" style="--min:280px">
      ...
      ${teamCard({ name: people.keletsoMakofane.name, role: people.keletsoMakofane.teamRole[locale], bio: people.keletsoMakofane.bio[locale] }, locale)}
    </div>
  </div>
</section>
